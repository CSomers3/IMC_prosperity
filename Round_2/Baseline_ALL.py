...
def market_make(self, bids, asks, product):
    ...
    logger.print(f"MAKING MARKET FOR {product} WITH BID {bid} AND ASK {ask}")
...
class Trader:
    def __init__(self):
        ...
        self.products = ["PEARLS", "BANANAS", "PINA_COLADAS", "COCONUTS"]
        ...
        self.min_profit = {"PEARLS": 0.01, "BANANAS": 2.5, "COCONUTS": 3, "PINA_COLADAS": 3}
        self.best_bid_prices = {product: [] for product in self.products}
        self.best_ask_prices = {product: [] for product in self.products}
        self.bid_ma = 0
        self.ask_ma = 0
